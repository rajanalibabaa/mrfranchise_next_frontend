...
const ExpansionLocationGrid = React.lazy(
  () =>
    import("@/Components/OverTabHandlings.jsx/BrandOverViewExpansionLocationDomestic.jsx"),
);
const ExpansionLocationGridInternational = React.lazy(
  () =>
    import("@/Components/OverTabHandlings.jsx/BrandExpansionLOcationOverviewInternational.jsx"),
);
const DescriptionIcon = React.lazy(
...
function LazyInViewSection({ children, fallback, minHeight = 120, ...props }) {
  ...
  return (
    <Box ref={ref} sx={{ minHeight, width: "100%" }} {...props}>
      {visible
        ? children
        : fallback || <SectionSkeleton height={minHeight / 3} />}
    </Box>
  );
}
...
const OverviewTab = ({ brand }) => {
  ...
  return (
    <Box ref={overviewRef}>
      ...
      {hasData(serviceTags) && (
        <FranchiseTagsOverView serviceTags={serviceTags} />
      )}
          ...
          <Grid item xs={12} md={6}>
            <SupportProvided
              ...
              isInternationalExpansion={
                franchiseDetails.isInternationalExpansion
              }
            />
          </Grid>
        </Grid>
      ...
      {!isMobile && (
        <>
          ...
          {hasData(
            expansionLocationData.currentOutletLocations?.international
              ?.country,
          ) && (
          ...
          {hasData(
            ...
            >
              ...
              <AccordionDetails>
                <LazyInViewSection minHeight={180}>
                  <Suspense
                    fallback={<SectionSkeleton lines={2} height={36} />}
                  >
                    <ExpansionLocationGrid
                      data={
                        expansionLocationData.currentOutletLocations.domestic
                      }
                    />
                  </Suspense>
                </LazyInViewSection>
              ...
              <AccordionDetails>
                <LazyInViewSection minHeight={160}>
                  ...
                  >
                    <ExpansionLocationGridInternational
                      data={
                        expansionLocationData.expansionLocations.international
                      }
                    />
                  </Suspense>
                </LazyInViewSection>
