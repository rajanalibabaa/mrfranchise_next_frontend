...
const CATEGORY_CONFIG = {
  ...
  "bakery-confectionery": {
    ...
    icon: "🎂",
    description: "Bakery shops, Cake shops, Confectionery stores, Dessert outlets",
    keywords: [
      "bakery franchise",
      "cake shop franchise",
  ...
  "education": {
    title: "Education",
    icon: "📚",
    description: "Preschools, Coaching centers, Online education, Skill development",
    keywords: [
      "preschool franchise",
      "coaching franchise",
      "education franchise",
...
export default async function Page({ params }) {
  ...
  const structuredData = generateStructuredData(categoryName, slug, config, brandCount);
