  ...
  return (
    ...
    >
      <Box>
        ...
        {/* Unified Table */}
        <TableContainer component={Paper} elevation={0} sx={{ boxShadow: "none", overflow: "visible" }}>
                ...
                return (
                  ...
                  >
                    ...
                    {isFirstRowOfTable && (
                      ...
                      >
                        <Box sx={{ display: "flex", flexDirection: "column", justifyContent: "space-evenly", height: "100%", width: "100%" }}>
                          <Box sx={{ display: "flex", flexDirection: "column", justifyContent: "space-evenly", width: "75%", margin: "0 auto", gap: 3, height: "100%" }}>
                            {filteredPlans.map((plan) => {
                              ...
                              return (
                                <Box
                                  ...
                                  sx={{
                                    py: 0.8, px: 1, textAlign: "center", borderRadius: 1.5, cursor: "pointer", transition: "all 0.2s ease",
                                ...
                                >
                                  <Box sx={{ display: "flex", flexDirection: "column", gap: 0.3, width: "100%" }}>
                                    <Typography sx={{ fontSize: TEXT_SIZES.medium, fontWeight: 600, color: selectedGroup === plan._id ? COLORS.white : COLORS.black }}>
                                      {uniqueValidityDaysForPlan[0]} Days Plan
                                    </Typography>
                                  </Box>
                                </Box>
                              );
                    ...
                    {isFirstInGroup && (() => {
                      return (
                        ...
                        >
                          <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", width: "100%", gap: 3 }}>
                            {/* Leads Options */}
                            {availableLeads.length > 0 ? (
                              <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 3, flexWrap: "wrap", mt: 1 }}>
                                  ...
                                  return (
                                    <Box
                                      ...
                                      sx={{
                                        ...
                                        cursor: isLockedInSummary ? "not-allowed" : "pointer",
                                        ...
                                        opacity: isLockedInSummary ? 0.5 : 1,
                                        whiteSpace: "nowrap",
                                        "&:hover": {
                                          backgroundColor: isLockedInSummary ? COLORS.white : isSelected ? COLORS.secondaryDark : COLORS.lightOrange,
                                        },
                                      }}
                                    >
                                      {leadOption}
                    ...
                    >
                      <Box sx={{ display: "flex", alignItems: "center", justifyContent: "flex-start", gap: 1 }}>
                        <Tooltip title={inPayment ? "Already added to cart" : "Select to add to cart"} arrow>
                          <span>
                            <Checkbox
                    ...
                    >
                      <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 0.5 }}>
                        ...
                        <Tooltip title="Edit States" arrow>
                          ...
                          >
                            <EditIcon sx={{ fontSize: TEXT_SIZES.small, color: COLORS.primary }} />
                          </IconButton>
                        </Tooltip>
                      </Box>
                    </TableCell>
                      ...
                      >
                        <Box sx={{ display: "flex", flexDirection: "column", gap: 3, alignItems: "center", justifyContent: "center", width: "100%" }}>
                          <Button
                            ...
                            sx={{
                              width: 90, minHeight: 85, height: "auto",
                              fontSize: "0.85rem", textTransform: "none", fontWeight: 700,
