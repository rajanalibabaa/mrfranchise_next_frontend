...
import { homeSection13 } from '@/Redux/Slices/TopCardFetchingSlice.jsx';
...
const HomeSection13 = () => {
  ...
  const homeSection13State = useSelector((state) => state.overAllPlatform.homeSection13);
  ...
  const handleScroll = useCallback(() => {
    ...
    if (
      ...
      dispatch(homeSection13({ page: nextPage }))
        .finally(() => {
...
export default React.memo(HomeSection13);