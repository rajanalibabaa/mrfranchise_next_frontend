...
import { homeSection11 } from '@/Redux/Slices/TopCardFetchingSlice.jsx';
...
const HomeSection11 = () => {
  ...
  const homeSection11State = useSelector((state) => state.overAllPlatform.homeSection11);
  ...
  const handleScroll = useCallback(() => {
    ...
    if (
      ...
      dispatch(homeSection11({ page: nextPage }))
        .finally(() => {
...
export default React.memo(HomeSection11);