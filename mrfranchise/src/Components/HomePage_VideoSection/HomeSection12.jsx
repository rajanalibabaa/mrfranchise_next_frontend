...
const HomeSection12 = () => {
  ...
  const homeSection12State = useSelector((state) => state.overAllPlatform.homeSection12);
  ...
  const handleScroll = useCallback(() => {
    ...
    if (
      ...
      dispatch(homeSection12({ page: nextPage }))
        .finally(() => {
...
export default React.memo(HomeSection12);